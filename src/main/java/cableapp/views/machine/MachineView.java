package cableapp.views.machine;
...
@Route(value = "machine", layout = MainView.class)
@PageTitle("Machine")
@CssImport("styles/views/machine/machine-view.css")
public class MachineView extends Div implements AfterNavigationObserver {
