...
@Route(value = "cable", layout = MainView.class)
@RouteAlias(value = "", layout = MainView.class)
@PageTitle("Cable")
@CssImport("styles/views/cable/cable-view.css")
public class CableView extends Div implements AfterNavigationObserver {
